...
const Hero = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[100vh] mx-auto bg-black">
      ...
      <div className="col-span-2 px-5 my-auto">
        ...
        <p className=" text-white font-sans sm:text-lg my-6 font-semibold ">
          I am actively preparing for a career as a software developer, enhancing my skills and knowledge to succeed in the field.
        </p>
        <div className="my-8">
            <DownloadCVButton/>
